...
Along with data, IPC can be used to send one capabilities between processes per message. This is referred to as 
...
To receive a capability, the receiver must specific a cspace address to place the capability in. This is 
...
The code example below demonstates this:
...
* The data in the message must fit into the message.
...
On initialisation, both clients use the following protocol: they make a wait on the provided endpoint for
