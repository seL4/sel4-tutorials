...
[IPC tutorial]: https://docs.sel4.systems/Tutorials/ipc.html
...
kernel's cap to a fault endpoint can be used to distinguish fault messages from
different faulting threads, such that a single handler can handle faults from
multiple threads. Please see the [IPC tutorial] for a refresher on how badged
fault endpoints work.
