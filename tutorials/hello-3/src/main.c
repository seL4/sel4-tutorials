...
void thread_2(void) {
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-11:
...
/*- endif -*/
     ...
     * build/x86/pc99/libsel4/include/sel4/types_gen.h
     * It is generated from the following definition:
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-12:
     */
/*- if solution -*/
...
/*- endif -*/
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-13:
     * You can find out more about message registers in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     */
/*- if solution -*/
    msg = seL4_GetMR(0);
/*- endif -*/
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-14:
     * You can find out more about message registers in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     */
/*- if solution -*/
    seL4_SetMR(0, msg);
/*- endif -*/
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-15:
     * You can find out more about it in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     *
     * hint 2: seL4_MessageInfo_t is generated during build.
     * The type definition and generated field access functions are defined in a generated file:
...
int main(void) {
     ...
     * @return 0 on success
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-1:
     */
...
/*- endif -*/
     ...
     * in: Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-2:
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-2:
     * You can find out more about it in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     *
...
/*- endif -*/
    ...
    if (error != 0) {
         ...
         * @return 0 on success
         * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-3:
         */
/*- if solution -*/
...
/*- endif -*/
         ...
         * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-4:
         * The signature for the underlying function is:
...
/*- endif -*/
     ...
     * @return 0 on success
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-6:
     */
/*- if solution -*/
...
/*- endif -*/
     ...
     * @return 0 on success
     *
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-7:
     *
     * hint 2: for the rights, use seL4_AllRights
...
/*- endif -*/
     ...
     * build/x86/pc99/libsel4/include/sel4/types_gen.h
     * It is generated from the following definition:
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-8:
     *
...
/*- endif -*/
     ...
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-9:
     * You can find out more about it in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     *
     * hint 2: seL4_MessageInfo_t is generated during build.
     * The type definition and generated field access functions are defined in a generated file:
...
/*- endif -*/
     ...
     * @param i The message register to retreive
     * @return The message register value
     * Link to source: https://docs.sel4.systems/Tutorials/seL4_Tutorial_3#task-10:
     * You can find out more about message registers in the API manual: http://sel4.systems/Info/Docs/seL4-manual-latest.pdf
     */
/*- if solution -*/
    msg = seL4_GetMR(0);
