...
void callback_handler_1(void *a) {
     ...
     * hint 8: look at https://github.com/seL4/camkes-tool/blob/2.0.0/docs/index.md#an-example-of-dataports
...
void callback_handler_2(void *a) {
     ...
     * hint 7: for more information about dataport pointers see: https://github.com/seL4/camkes-tool/blob/2.0.0/docs/index.md
